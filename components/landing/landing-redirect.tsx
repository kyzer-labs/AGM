 ...
 *  - Visitors who just completed the Microsoft popup sign-in observe a
 *    short moment on the landing and then get redirected as soon as the
 *    Firebase ID token propagates to Convex.
 *
 ...
 * popup, persisted localStorage on revisit, or a browser back button.
 *
